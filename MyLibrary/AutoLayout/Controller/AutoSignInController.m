...
@interface AutoSignInController () <OrderInfoViewDelegate>
...
-(instancetype)init
{
    if (self = [super init]) {
        ...
        OrderProcessFlowView *flowView = [OrderProcessFlowView flowViewWithOrder:order];
...
{
    CGRect titleRect = [sender titleRectForContentRect:sender.frame];
...
//{
//    [self.flowView setNeedsUpdateConstraints];
//}
