...
- (void)addNode
{
    ...
    if (toogle) {
        ...
        NSDictionary *dict1 = @{K_NODEVIEW_LABEL1:@"地点",K_NODEVIEW_LABEL2:@"基隆场地基隆场地基隆场地基隆场地基隆场地基隆场地基隆场地基隆场地基隆场地基隆场地基隆场地基隆",K_NODEVIEW_ICON:@"signIn_location"};
        NSDictionary *dict2 = @{K_NODEVIEW_LABEL1:@"提柜时间",K_NODEVIEW_LABEL2:@"08-24 8:00",K_NODEVIEW_ICON:@""};
        NSArray *arr = @[dict1,dict2];
            OrderProcessFlowNodeView *flowNodeView = [OrderProcessFlowNodeView nodeViewWithArray:arr];
    ...
    [imageView makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(nodeView).offset(42);
